...
<div class="container-fluid">
    <div class="text-end m-2"><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalTambahpopuler"> + Tambah Barang Baru</button></div>
    @if(session('message'))
    ...
    <table class="table table-dark table-hover m-lg-2">
        ...
        <tr>
            ...
            <td>
                ...
                <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#ModalUpdatepopuler{{ $p->kode }}">Update</button>
                |
                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#ModalDeletepopuler{{ $p->kode }}">Delete</button>
            </td>
        </tr>

        <!-- Ini tampil form update produk -->
        <div class="modal fade" id="ModalUpdatepopuler{{ $p->kode }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Update populer</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="/populer/storeupdate" method="post" class="form-floating">
                            @csrf
        ...
        <div class="modal fade" id="ModalDeletepopuler{{$p->kode}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="/populer/delete/{{$p->kode}}" method="get" class="form-floating">
                            @csrf
                            <div>
...
<div class="modal fade" id="ModalTambahpopuler" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="/populer/storeinput" method="post" class="form-floating" enctype="multipart/form-data">
                    @csrf
                    <div class="form-floating p-1">
