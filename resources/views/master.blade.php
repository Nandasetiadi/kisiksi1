        ...
        <div class="container-fluid">
            <div class="me-5">
                <a class="navbar-brand" href="{{route('dashboard')}}">
                    <img src="\img\7377cf3bb5b747377c6b1f583da22299.jpg" alt="Logo" width="60" height="54" class="d-inline-block align-text-top">
                    <b class="fs-3">Tobuk</b>
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-5 me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/populer/tampil">Populer</a>
                    </li>
